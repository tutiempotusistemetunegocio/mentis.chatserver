...
Cada vez que se abre el panel, el servidor baja de Dropbox el catálogo de guías, los dos historiales de contenido y las oportunidades de estrategia — cinco archivos chicos. Para un uso personal y esporádico esto es más simple que mantener una copia sincronizada aparte, pero significa que cada visita tarda un segundo o dos de más mientras trae los datos frescos.
