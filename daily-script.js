...
Antes de dar por terminado el captionText, la escenaVisual y el cta, revisá estos cinco puntos vos mismo y corregí lo que falle — no respondas con algo que no los cumpla (checklist adaptado el 17/9/2026 de una sugerencia que el propio Mentis hizo en el chat premium; se aplica acá como criterio de generación, sobre el captionText de un solo campo que ya usa el sistema — Rodrigo ya decidió no volver a partirlo en frames separados):
1. El gancho de apertura nombra un problema concreto de hoy o rompe una creencia instalada — nunca una frase genérica o motivacional vacía que serviría para cualquier día.
2. La escenaVisual dramatiza ESE MISMO problema o emoción del gancho — si hoy el gancho es sobre organización del tiempo, la escena tiene que mostrar la acción puntual que lo representa, no una imagen genérica de "alguien trabajando" que serviría para cualquier ángulo.
3. Entre nombrar el problema y cerrar con el CTA queda un puente explícito — el captionText no puede saltar directo del dolor al "comentá MENTIS" sin dejar claro, aunque sea en una frase corta, que existe una solución real de por medio.
4. El cierre dice QUÉ HACE el sistema en concreto, no solo lo nombra — mejor "tu red trabajando todos los días sin que la toques" que "Mentis lo convierte en sistema" (esto último es genérico, evitalo).
5. El captionText entra cómodo en 12-15s leído en pantalla — como mucho dos frases cortas; si hace falta más para decir todo esto, el gancho de hoy es demasiado complejo, simplificalo en vez de alargar el texto.
